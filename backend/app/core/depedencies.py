...
MongoDatabaseDependency = Annotated[
    AsyncDatabase,
...
AddressValidationDedency = Annotated[AddressValidation, Depends(get_address_validation)]
...
def get_address_repository(database: MongoDatabaseDependency) -> AddressRepository:
    """提供地址数据访问层实例。"""
